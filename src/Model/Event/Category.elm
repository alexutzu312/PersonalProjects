...
type SelectedEventCategories
    = SelectedEventCategories {academicEvent : Bool , workEvent : Bool , projectEvent : Bool , awardEvent : Bool}
...
allSelected =
    SelectedEventCategories {academicEvent = True , workEvent = True , projectEvent = True , awardEvent = True}
...
noneSelected =
    SelectedEventCategories {academicEvent = False , workEvent = False , projectEvent = False , awardEvent = False}
...
isEventCategorySelected category current =
    ...
    in 
        case category of 
            Academic -> categories.academicEvent 
            Work -> categories.workEvent 
            Project -> categories.projectEvent 
            Award -> categories.awardEvent
...
set category value current =
    ...
    in 
        case category of 
            Academic -> SelectedEventCategories {academicEvent = value , workEvent = categories.workEvent , projectEvent = categories.projectEvent , awardEvent = categories.awardEvent} 
            Work -> SelectedEventCategories {academicEvent = categories.academicEvent , workEvent = value , projectEvent = categories.projectEvent , awardEvent = categories.awardEvent} 
            Project -> SelectedEventCategories {academicEvent = categories.academicEvent , workEvent = categories.workEvent , projectEvent = value , awardEvent = categories.awardEvent} 
            Award -> SelectedEventCategories {academicEvent = categories.academicEvent , workEvent = categories.workEvent , projectEvent = categories.projectEvent , awardEvent = value} 
...
view model =
    let 
        (SelectedEventCategories m) = model 
    in 
        div [] [ 
            checkbox "Academic" m.academicEvent Academic 
            ,checkbox "Work" m.workEvent Work 
            ,checkbox "Project" m.projectEvent Project 
            ,checkbox "Award" m.awardEvent Award ]
